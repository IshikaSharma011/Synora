-- Smart Notes — full schema for a fresh Supabase project.
-- Paste this whole file into: Supabase Dashboard → SQL Editor → New query → Run.
-- This is the end result of the project's 3 migrations, with the old
-- Instagram-DM tables (created and then dropped along the way) left out.
